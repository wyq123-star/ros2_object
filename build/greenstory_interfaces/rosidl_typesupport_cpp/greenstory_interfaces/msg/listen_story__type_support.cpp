...
static const _ListenStory_type_support_symbol_names_t _ListenStory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, greenstory_interfaces, msg, ListenStory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, greenstory_interfaces, msg, ListenStory)),
  }
};
...
{
  return &::greenstory_interfaces::msg::rosidl_typesupport_cpp::ListenStory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, greenstory_interfaces, msg, ListenStory)() {
  return get_message_type_support_handle<greenstory_interfaces::msg::ListenStory>();
}
